...
def crear_venta_contado(*, items, cliente_id, vendedor, forma_pago, cfg_gen):
    ...
    for item in items_resueltos:
        ...
        registrar_movimiento(
            item['prod'], MovimientoInventario.VENTA,
            stock_anterior=stock_previo, stock_nuevo=item['prod'].stock,
            usuario=vendedor, referencia=f'Venta #{venta.pk}',
        )
